              ...
              <form onSubmit={handleSignup} className="space-y-5">
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <Input
                      ...
                      required
                      className="w-full bg-black/40 border-white/10 placeholder:text-gray-500 focus:ring-white/30 pl-10"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    ...
                    <select
                      ...
                      className="w-full bg-black/40 border-white/10 focus:ring-white/30 border rounded-lg py-3 pl-10 pr-4 appearance-none focus:ring-1 focus:outline-none [&:-webkit-autofill]:shadow-[0_0_0_1000px_transparent_inset] [&:-webkit-autofill]:text-fill-foreground"
                    >
                  ...
                  {role === 'admin' && (
                    <p className="mt-1 text-xs text-gray-400">Administrators manage emergency responses and allocate resources</p>
                  )}
                </div>
                ...
                {showAdminField && (
                  <div className="space-y-1">
                    ...
                    <p className="mt-1 text-xs text-gray-400">Contact system administrator for this code</p>
                  </div>
                )}
                ...
                <Button
                  type="submit"
                  disabled={isLoading}
                  className="w-full rounded-lg font-medium py-3 flex items-center justify-center transition-colors disabled:opacity-50 bg-white text-black hover:bg-white/90"
                >
                  {isLoading ? (
