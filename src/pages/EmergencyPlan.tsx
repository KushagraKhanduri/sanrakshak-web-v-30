      ...
      <main className="pt-20 pb-16 w-full">
        <div className="w-full px-4 sm:px-6 md:px-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400">Hurricane Category 3 Response Plan</p>
          </div>
          
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-black/30 border border-white/10 rounded-xl p-6 shadow-soft">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-300 text-sm mt-1">
                        If in zones A, B, or C, evacuate immediately to designated shelters or move inland. Check the <Link to="/shelter-map" className="text-white underline">Shelter Map</Link> for locations.
                      </p>
                    </div>
                  </div>
              ...
              <div className="bg-black/30 border border-white/10 rounded-xl p-6 shadow-soft">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-black/40 border border-white/5 rounded-lg p-4">
                    ...
                    <p className="text-sm text-gray-300">1 gallon per person per day for at least 3 days</p>
                  </div>
                  
                  <div className="bg-black/40 border border-white/5 rounded-lg p-4">
                    <h3 className="font-medium mb-2">Food</h3>
                    <p className="text-sm text-gray-300">Non-perishable food for at least 3 days</p>
                  </div>
                  
                  <div className="bg-black/40 border border-white/5 rounded-lg p-4">
                    <h3 className="font-medium mb-2">Medications</h3>
                    <p className="text-sm text-gray-300">7-day supply of medications and medical items</p>
                  </div>
                  
                  <div className="bg-black/40 border border-white/5 rounded-lg p-4">
                    <h3 className="font-medium mb-2">Power</h3>
                    <p className="text-sm text-gray-300">Flashlights, batteries, portable chargers</p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-6">
              <div className="bg-black/30 border border-white/10 rounded-xl p-6 shadow-soft">
                ...
                <div className="space-y-3">
                  <div className="border-l-4 border-white bg-white/5 pl-3 py-2 rounded-r">
                    <p className="text-sm font-medium">Hurricane Warning Active</p>
                    <p className="text-xs text-gray-400">Until Thursday 8:00 PM</p>
                  </div>
                  
                  <div className="border-l-4 border-gray-500 bg-white/5 pl-3 py-2 rounded-r">
                    <p className="text-sm font-medium">Flash Flood Watch</p>
                    <p className="text-xs text-gray-400">Until Friday 6:00 AM</p>
                  </div>
                </div>
                
                <Link to="/alerts" className="flex justify-center w-full mt-4 text-sm bg-white/10 hover:bg-white/15 py-2 rounded-lg transition-colors border border-white/10">
                  View All Alerts
                </Link>
              </div>
              ...
              <div className="bg-black/30 border border-white/10 rounded-xl p-6 shadow-soft">
                ...
                <div className="space-y-3">
                  <Link to="/resources" className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg transition-colors border border-white/10">
                    <p className="text-sm font-medium">Community Resources</p>
                    <p className="text-xs text-gray-400">Find or offer help</p>
                  </Link>
                  
                  <Link to="/map" className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg transition-colors border border-white/10">
                    <p className="text-sm font-medium">Emergency Services Map</p>
                    <p className="text-xs text-gray-400">Locate nearby services</p>
                  </Link>
                  
                  <Link to="#" className="block p-3 bg-white/5 hover:bg-white/10 rounded-lg transition-colors border border-white/10">
                    <p className="text-sm font-medium">Preparedness Guide</p>
                    <p className="text-xs text-gray-400">Download PDF (1.2MB)</p>
                  </Link>
                </div>
              </div>
            </div>
