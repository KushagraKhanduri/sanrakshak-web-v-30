      ...
      <div className="w-full px-4 sm:px-6 md:px-8 grid grid-cols-1 lg:grid-cols-3 gap-6 relative">
              ...
              {loading ? (
                ...
                availableResources.map(resource => (
                  <ResourceCard
                    ...
                    isRequested={user?.id && user.role === 'ngo' && respondedRequestIds.has(resource.id)}
            ...
            <AnimatedTransition className="mb-6" delay={150}>
              <div className="flex items-center justify-between mb-4">
                ...
                <Button
                  ...
                  className="text-gray-400 hover:text-white transition-colors"
                >
                  <Link to="/ngo-resources" className="flex items-center">
                    <span className="mr-1">View All</span>
                    <ArrowRight size={14} />
                  </Link>
                </Button>
        ...
        <div>
            ...
            <div className="rounded-2xl border border-white/10 p-4 sm:p-6 bg-black/40 backdrop-blur-sm shadow-lg">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <Button asChild className="w-full">
                  <Link to="/ngo-resources">Offer Resources</Link>
                </Button>
                <Button asChild className="w-full">
                  <Link to="/ngo-tasks">View Assigned Tasks</Link>
                </Button>
                <Button asChild className="w-full">
          ...
          <AnimatedTransition delay={250}>
            <div className="rounded-2xl border border-white/10 p-4 sm:p-6 bg-black/40 backdrop-blur-sm shadow-lg">
              <h2 className="text-xl font-semibold mb-4">NGO Stats</h2>
              
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <span>Resources Offered:</span>
                  <span className="font-semibold">75</span>
                </div>
                
                <div className="flex items-center justify-between">
                  <span>Tasks Completed:</span>
                  <span className="font-semibold">22 Tasks</span>
                </div>
              ...
              <Button asChild variant="outline" className="w-full mt-4">
                <Link to="/ngo-stats">View Full Stats</Link>
              </Button>
            </div>
          </AnimatedTransition>
        </div>
