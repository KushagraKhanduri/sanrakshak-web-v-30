  ...
  return (
    <div 
      className={cn(
        ...
        isLight 
          ? (available ? 'bg-white border-gray-300 shadow-soft' : 'bg-gray-50 border-gray-300') 
          : (available ? 'bg-black/40 backdrop-blur-sm border-white/10' : 'bg-black/20 border-white/5'),
        className
      )}
    >
      <div className="p-4">
